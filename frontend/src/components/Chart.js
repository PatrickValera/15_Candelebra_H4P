...
const Chart = ({ticker,portfolio,cash,setPortfolio,setCash}) => {
  ...
  return (
    <>
      <Typography variant='h6' color='green'>{ticker}</Typography>
      ...
      <Button onClick={()=>{
        ...
        setCash(state=>(state-currentPrice*10))
